...
struct EventKinematics {
    ...
    up_TTO_TH1F hist1D_W_cut = std::make_unique<TTO_TH1F>("W", "", nbBins1D, 0, 5);
    up_TTO_TH1F hist1D_Q2_cut = std::make_unique<TTO_TH1F>("Q2", "", nbBins1D, 0, 10);
    up_TTO_TH1F hist1D_nu_cut = std::make_unique<TTO_TH1F>("nu", "", nbBins1D, 0, 10);
    up_TTO_TH1F hist1D_t_cut = std::make_unique<TTO_TH1F>("t", "", nbBins1D, 0, 2);
    up_TTO_TH1F hist1D_zh_cut = std::make_unique<TTO_TH1F>("zh", "", nbBins1D, 0, 2);
    up_TTO_TH1F hist1D_lc_cut = std::make_unique<TTO_TH1F>("lc", "", nbBins1D, 0, 5);
};
